...
class Strategy:
    ...
    def process(self, field: fld.Field) -> list[Optional[Action]]:
        ...
        match field.game_state:
            ...
            case GameStates.HALT:
                ...
                actions[self.attacker1_id_global] = Actions.Stop()
                actions[self.attacker2_id_global] = Actions.Stop()
            ...
            case GameStates.PREPARE_KICKOFF:
                if self.we_active == False:
                    if field.ally_color == const.Color.YELLOW:
                        self.GoalKeeper.go(field, actions, attacker1_id = self.attacker1_id_global, attacker2_id = self.attacker2_id_global, goal_keeper_id = const.GK)
                        actions[self.attacker2_id_global] = Actions.GoToPoint(aux.Point((800)*field.polarity, 0), (field.ball.get_pos() - field.y_team[self.attacker2_id_global].get_pos()).arg())
                        ...
                        self.GoalKeeper.go(field, actions, attacker1_id = self.attacker1_id_global, attacker2_id = self.attacker2_id_global, goal_keeper_id = const.GK)
                        actions[self.attacker2_id_global] = Actions.GoToPoint(aux.Point((800)*field.polarity, 0), (field.ball.get_pos() - field.b_team[self.attacker2_id_global].get_pos()).arg())
                    ...
                    if field.ally_color == const.Color.BLUE:
                        self.GoalKeeper.go(field, actions, attacker1_id = self.attacker1_id_global, attacker2_id = self.attacker2_id_global, goal_keeper_id = const.GK)
                        actions[self.attacker1_id_global] = Actions.GoToPoint(aux.Point(2000*field.polarity,0),(field.ball.get_pos() - field.b_team[self.attacker1_id_global].get_pos()).arg())
                        actions[self.attacker2_id_global] = Actions.GoToPoint(aux.Point(120*field.polarity, 0), (field.ball.get_pos() - field.b_team[self.attacker2_id_global].get_pos()).arg())
                    else:
                        self.GoalKeeper.go(field, actions, attacker1_id = self.attacker1_id_global, attacker2_id = self.attacker2_id_global, goal_keeper_id = const.GK)
                        actions[self.attacker1_id_global] = Actions.GoToPoint(aux.Point(2000*field.polarity,0),(field.ball.get_pos() - field.y_team[self.attacker1_id_global].get_pos()).arg())
                        actions[self.attacker2_id_global] = Actions.GoToPoint(aux.Point(120*field.polarity, 0), (field.ball.get_pos() - field.y_team[self.attacker2_id_global].get_pos()).arg())
            ...
            case GameStates.FREE_KICK:
                if self.we_active == True:
                    ...
                    if field.ally_color == const.Color.BLUE:
                        self.GoalKeeper.go(field, actions, attacker1_id = self.attacker1_id_global, attacker2_id = self.attacker2_id_global, goal_keeper_id = const.GK)
                        actions[self.attacker1_id_global] = Actions.GoToPoint(aux.Point(-1000*field.polarity,0), (field.ball.get_pos()-field.b_team[self.attacker1_id_global].get_pos()).arg())
                        actions[self.attacker2_id_global] = Actions.GoToPoint(aux.Point(-500*field.polarity,0), (field.ball.get_pos()-field.b_team[self.attacker2_id_global].get_pos()).arg())
                    else:
                        self.GoalKeeper.go(field, actions, attacker1_id = self.attacker1_id_global, attacker2_id = self.attacker2_id_global, goal_keeper_id = const.GK)
                        actions[self.attacker1_id_global] = Actions.GoToPoint(aux.Point(-1000*field.polarity,0), (field.ball.get_pos()-field.y_team[self.attacker1_id_global].get_pos()).arg())
                        actions[self.attacker2_id_global] = Actions.GoToPoint(aux.Point(-500*field.polarity,0), (field.ball.get_pos()-field.y_team[self.attacker2_id_global].get_pos()).arg())
            case GameStates.STOP:
                # The router will automatically prevent robots from getting too close to the ball
                if field.ally_color == const.Color.BLUE:
                    actions[self.attacker1_id_global] = Actions.GoToPoint(aux.Point(1750*field.polarity, -675), 0)
                    actions[self.attacker2_id_global] = Actions.GoToPoint(aux.Point(1750*field.polarity, 675), 0)
                else:
                    actions[self.attacker1_id_global] = Actions.GoToPoint(aux.Point(-1750*field.polarity, -675), 0)
                    actions[self.attacker2_id_global] = Actions.GoToPoint(aux.Point(-1750*field.polarity, 675), 0)
        return actions
    ...
    def run(self, field: fld.Field, actions: list[Optional[Action]]) -> None:
        ...
        if field.ally_color == const.Color.BLUE:
            ...
            field.strategy_image.draw_circle(field.b_team[const.GK].get_pos(), (255,255,255), 1500)
